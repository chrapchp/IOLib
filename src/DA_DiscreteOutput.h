...
public:
  ...
  void setActiveState(bool aState);

  // set to default active state
  void reset();

  // if disabled value written will be the non active state. e.g is active low,
  // high will be written
...
#endif // ifndef DA_DISCRETE_OUTPUT_H
